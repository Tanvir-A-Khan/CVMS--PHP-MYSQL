...
<head>
  ...
  <link
    ...
    rel="stylesheet">
  <link rel="stylesheet" href="css/repassSuccess(P).css">
</head>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav m-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="vaccineinfo.html">Vaccine Information</a>
          </li>
          <li class="nav-item">
  ...
  <section id="banner">
    <div class="container">
      ...
      <div class="accountreated">
        ...
        <button class="donebtn" onclick="window.location.href='homepage.php';">Login</button>
      </div>
    </div>
  </section>
